...
# Updated to use correct spelling
models_to_track = ['PurchaseRequest', 'Item', 'RequestForQuotation', 'AbstractOfQuotation']
...
for model_name in models_to_track:
    try:
        ...
        logger.info(f"Connected signals for model: {model_name}")
    except LookupError:
